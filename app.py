...
st.title("Groww Equity + MTF + Tax (Take Home) Calculator")
st.caption("Equity charges based on values visible in your Groww screenshot (approx). Tax is an estimate.")
